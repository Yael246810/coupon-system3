...
class WebApiService {
  ...
  public addCustomer(
    ...
    return axios.post<CustomerModel>(
      `${UrlService.admin}/customer`,
      customer,
      authService.getPostHeaders()
    );
  }
  ...
  public getSingleCustomer(
    ...
    return axios.get(
      `${UrlService.admin}/customers/${customerId}`,
      authService.getPostHeaders()
    );
  }
  public PurchaseCoupon(
    ...
    return axios.post(
      `${UrlService.customer}/${customerId}/coupons/${couponId}/purchase`,
      null,
      authService.getPostHeaders()
    );
  }
  ...
  public getCustomerCoupons(id: number): Promise<AxiosResponse<CouponModel[]>> {
    return axios.get(
      `${UrlService.customer}/${id}/coupons`,
  ...
  public getCustomerCouponsByMaxPrice(
    ...
    return axios.get(
      `${UrlService.customer}/${id}/coupons/price?max=${price}`,
      authService.getHeaders()
    );
  }
  public getCustomerCouponsByCategory(
    ...
    return axios.get(
      `${UrlService.customer}/${id}/coupons/category?val=${Category[category]}`,
      authService.getHeaders()
    );
  }
  public deletePurchasedCoupon(
    couponId: number,
    customerId: number
  ): Promise<AxiosResponse<any>> {
    return axios.delete<any>(
      `${UrlService.customer}/${customerId}/coupons/${couponId}/delete`,
      authService.getHeaders()
    );
  }
  public getCustomerDetails(
    customerId: number
  ): Promise<AxiosResponse<CustomersModel>> {
    return axios.get(
      `${UrlService.customer}/${customerId}/details`,
      authService.getHeaders()
    );
  }
}
