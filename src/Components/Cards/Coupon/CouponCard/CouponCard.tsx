    ...
    <div className="CouponCard">
      ...
      <div className="coupon-details">
        ...
        <div className="coupon-info">
          <p className="coupon-info-item">Category: {Category[props.coupon.category]}</p>
          <p className="coupon-info-item">Price: ${props.coupon.price}</p>
          <p className="coupon-info-item">Start Date: {moment(props.coupon.startDate).format("DD/MM/YY")}</p>
          <p className="coupon-info-item">End Date: {moment(props.coupon.endDate).format("DD/MM/YY")}</p>
        ...
        <div className="coupon-buttons">
          {props.isCompanyConnected ? (
            ...
            <>
              <Link to={`/customers/${props.customerId}/coupons/${props.coupon.id}/delete`}>
                <button className="coupon-button">Delete Purchased Coupon</button>
              </Link>
            </>
          )}
        </div>
